        ...
        <div style="width: 300px;">
            ...
            <form id="login_form">
                ...
                <div class="mb-3">
                    ...
                    <input type="email" class="form-control" id="email_field" name="email_field" placeholder="eg:onizuka@mail.com">
                </div>
                <div class="mb-3">
                ...
                <div style="display:flex;">
                    <button type="button" id="form_btn" class="btn btn-success">Sign In</button>

                    <button type="button" class="btn btn-warning" onclick="window.location.href='../sign_up/'">Sign Up</button>
                </div>
